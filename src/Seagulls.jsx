...
export function Seagulls(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/models/海鸥.glb");
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      {props.ready && (
        <PositionalAudio autoplay loop url="/audio/seagulls.mp3" distance={20} />
      )}
